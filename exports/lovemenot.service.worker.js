...
/** @type {string} */
const CACHE_VERSION = '1738899390|6000160892';
/** @type {string} */
const CACHE_PREFIX = 'lovemenot-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'lovemenot.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["lovemenot.html","lovemenot.js","lovemenot.offline.html","lovemenot.icon.png","lovemenot.apple-touch-icon.png","lovemenot.worker.js","lovemenot.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["lovemenot.wasm","lovemenot.pck","lovemenot.side.wasm"];
